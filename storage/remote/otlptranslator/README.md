...
This is because the packages we copy depend on the [`prompb`](https://github.com/zzylol/prometheus-sketches/blob/main/prompb) package. While the package is relatively stable, there are still changes. For example, https://github.com/zzylol/prometheus-sketches/pull/11935 changed the types.
