...
require (
	...
	github.com/froot-netsys/promsketch v0.3.20
...
require (
	...
	github.com/zzylol/prometheus-sketch-VLDB/uniform-sampling-caching/prometheus v0.0.0-20240923164734-ca52c3f57828 // indirect
