...
func TestDeriv(t *testing.T) {
	// https://github.com/zzylol/prometheus-sketches/issues/2674#issuecomment-315439393
	...
	// https://github.com/zzylol/prometheus-sketches/issues/7180
	for i = 0; i < 15; i++ {
		jitter := 12 * i % 2
	...
	query, err := engine.NewInstantQuery(ctx, storage, nil, "deriv(foo[30m])", timestamp.Time(1493712846939), false)
