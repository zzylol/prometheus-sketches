...
// DummyTargetRetriever implements github.com/zzylol/prometheus-sketches/web/api/v1.ScrapePoolsRetriever.
...
// DummyTargetRetriever implements github.com/zzylol/prometheus-sketches/web/api/v1.targetRetriever.
